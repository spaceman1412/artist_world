...
import {
  ...
  renderComposer,
  renderMessageText,
} from './messageStyle/messageStyle';
...
const MessageModal = (props: MessageModalProps) => {
  ...
  return (
    <Modal transparent={true} animationType="slide" {...rest}>
      <TouchableOpacity onPress={onclose} style={styles.overplayed} />
      <View style={styles.container}>
        <View style={styles.wrapper}>
          <TouchableOpacity
            onPress={() => {
              navigation.navigate('profileDetail', {uid: room.id});
              onclose();
            }}>
