import {  Image, Pressable , StyleSheet, View, Text, SafeAreaView } from "react-native";
   ...
   return(
    <SafeAreaView style={styles.container}>
        ...
        <View style={styles.imageContainer}>
            <Image source={require('./img/forgot_Password.png')}
        ...
        <View >
            ...
            <View >
                <Pressable style={choice === 1 ? styles.selected : styles.options } onPress={() => setChoice(1)}>
                ...
                <Pressable style={ choice === 2 ? styles.selected: styles.options} onPress={() => setChoice(2)}>
